        ...
        <footer id="contact">
            <Section bg="bg-gray-100">
                <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-16 space-y-16 lg:space-y-0">
                    <div className='space-y-16 col-span-2'>
                        ...
                        <div className='grid md:grid-cols-2 gap-10'>
                            <div className='flex space-x-4'>
                                ...
                                <div>
                                    <h5 className='text-xs text-gray-900 font-semibold'>Email</h5>
                    ...
                    <div className=''>
                        <div className="bg-white rounded shadow-2xl shadow-gray-200 px-10 py-16 lg:-mt-16">
            ...
            <Section no={true} bg='bg-gray-900'>
                <div className="py-20 text-gray-400 grid md:grid-cols-3 md:gap-16 space-y-5 md:space-y-0 mb-14 md:mb-0">
                    <div>
                        <div className='w-36'>
