                    ...
                    <div className='-mt-24 lg:mt-0 lg:order-last'>
                        ...
                        <div className="p-10 bg-gray-100">
                            ...
                            </p>
                            {
                                ...
                                &&
                                <>
                                    <h5 className='text-gray-600 font-semibold mt-4'>Honors and Awards</h5>
                                    <p>
                                        {lawyer.attributes.Education.join(", ")}.
                                    </p>
                                </>
...
export async function getStaticPaths() {
    ...
    const paths = await lawyers.map(law => ({ params: { slug: law.attributes.slug }, locale: law.attributes.locale?.includes('es-MX') ? 'es' : 'en' }));
    return {
        paths,
        fallback: false,
    };
