                            ...
                            return (
                                <div key={result.id} className="rounded">
                                    ...
                                    <div className='bg-slate-100 p-10'>
                                        ...
                                        <h3 className='text-sm text-slate-400 mt-2'>{result.attributes.title}</h3>
                                        <h5 className='mt-6 text-amber-400 font-bold text-2xl'>${new Intl.NumberFormat('en-US').format(result.attributes.compensation)}</h5>
                                    </div>
                                </div>
                            )
                        })
